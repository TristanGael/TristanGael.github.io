...
const translations = {
    en: {
        ...
        'cap4-desc': 'Processing and analyzing behavioral data in R, Python, or MATLAB — from raw logs to statistical results ready for a paper or a client report.',
        ...
        'background-p2': 'I hold a Master\'s degree in Cognitive Psychology from Paris Descartes University, where I researched adaptation to non-individual Head-Related Transfer Functions for spatial audio in VR. I began PhD studies at the Conservatoire National des Arts et Métiers (CNAM) in Paris, specialized in Human-Computer Interaction, researching the use of virtual reality for neuropsychological assessment and rehabilitation — focused on diagnosing Unilateral Spatial Neglect and developing new therapeutic approaches. These studies were not completed.',
        ...
        'fact1-label': 'Peer-reviewed publications in VR-based neuropsychological assessment and spatial audio perception',
        'fact2-label': 'Full research projects taken from question to publication',
        'fact3-label': 'Cognitive Psychology, Paris Descartes University',
        'fact4-label': 'Studies in Human-Computer Interaction, CNAM Paris (not completed)',
        ...
        'contact-p2': 'I\'m also interested in research collaborations, academic partnerships, and PhD supervision opportunities.',
    ...
    fr: {
        ...
        'cap4-desc': 'Traitement et analyse de données comportementales en R, Python ou MATLAB — des journaux bruts aux résultats statistiques prêts pour un article ou un rapport.',
        ...
        'background-p2': 'Je suis titulaire d\'un Master en Psychologie Cognitive de l\'Université Paris Descartes, où j\'ai étudié l\'adaptation aux fonctions de transfert relatives à la tête (HRTF) non individuelles pour l\'audio spatial en RV. J\'ai entamé un doctorat au Conservatoire National des Arts et Métiers (CNAM) à Paris, spécialisé en interaction homme-machine, portant sur l\'utilisation de la réalité virtuelle pour l\'évaluation neuropsychologique et la réhabilitation — avec un focus sur le diagnostic de la négligence spatiale unilatérale et le développement de nouvelles approches thérapeutiques. Ce doctorat n\'a pas été achevé.',
        ...
        'fact1-label': 'Publications à comité de lecture en évaluation neuropsychologique en RV et perception audio spatiale',
        'fact2-label': 'Projets de recherche menés de la question à la publication',
        'fact3-label': 'Psychologie cognitive, Université Paris Descartes',
        'fact4-label': 'Études en interaction homme-machine, CNAM Paris (non achevées)',
        ...
        'contact-p2': 'Je suis également intéressé par des collaborations de recherche, des partenariats académiques et des opportunités d\'encadrement doctoral.',
