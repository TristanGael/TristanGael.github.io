...
const translations = {
    en: {
        ...
        'nav-contact': 'Contact',
        'nav-cv': 'CV',
        'hero-title': 'VR &amp; Behavioral <span class="accent">Research Prototyping</span>',
        ...
        'cap1-title': 'VR research prototyping',
        'cap1-desc': 'Building Unity-based VR applications to run controlled experiments — stimulus presentation, interaction design, and precise behavioral logging inside immersive environments.',
        ...
        'proj2-problem': 'The use of Head-Related Transfer Functions (HRTFs) can improve immersion and sound-localization accuracy in VR, but measuring individual HRTFs is impractical outside specialized labs.',
    ...
    fr: {
        ...
        'nav-contact': 'Contact',
        'nav-cv': 'CV',
        'hero-title': 'Prototypage pour la <span class="accent">recherche comportementale &amp; RV </span>',
        ...
        'cap1-title': 'Prototypage de recherche en RV',
        'cap1-desc': 'Développement d\'applications RV sous Unity pour mener des expériences contrôlées — présentation de stimuli, conception d\'interactions et enregistrement précis du comportement en environnement immersif.',
        ...
        'proj2-problem': 'L\'utilisation des fonctions de transfert relatives à la tête (HRTF) peut améliorer l\'immersion et la précision de la localisation sonore en RV, mais la mesure de HRTF individuelles reste peu praticable hors des laboratoires spécialisés.',
